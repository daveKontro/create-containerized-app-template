...
const run = async () => {
  const repo = 'https://github.com/daveKontro/create-containerized-app-template/tarball/main'
  ...
  if (!argv.name) {
    console.error('WARNING add a project name like so: npx create-containerized-app-template --name={my-project}')
    process.exit(1)
  }
  ...
  // finish up
  console.info('')
  console.info('Thanks for using Create Containerized App Template!')
